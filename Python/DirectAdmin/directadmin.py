...
$Id: api.py 73 2014-01-07 16:51:51Z andresgattinoni $
"""

__author__ = "Andrés Gattinoni <andresgattinoni@gmail.com>"
__version__ = "$Revision: 73 $"
    ...
    def execute(self, cmd, parameters=None, get=None):
        ...
        try:
            if self._cert:
                ...
                return self._handle_response(urllib2.urlopen(request, context=context))
